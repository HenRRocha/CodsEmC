...
int main (){
	...
	int o_ano = 0;         // => guardar o ano em questão 
...
int print_meses ( int comeco, int mes1, int mes2 ){ // => função para imprimir um par de meses
...
int printAno (int D, int ANO){   //=> função que chama a função para imprimir na sua respectiva ordem e quantidade 
